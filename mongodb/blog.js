...
exports.editComment = async function(client,id,payload,cid, res){
    try{
        ...
        result = await client.db("CUPartTime").collection("Blogs").updateOne({_id:id, "comments.cid":cid},{$set:{"comments.$.msg":payload.msg}})
...
exports.deleteComment = async function(client,id,cid, res){
    try{
       result = await client.db("CUPartTime").collection("Blogs").updateOne({_id:id},{$pull:{comments:{cid:cid}}})
        if(result.modifiedCount > 0){
